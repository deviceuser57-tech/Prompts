...
const PATHS: Record<string, React.ReactNode> = {
  ...
  upload: (
    <>
      <path d="M12 21v-11m0 0l-4.5 4.5M12 10l4.5 4.5M4 5.5h16" />
    </>
  ),
  plus: <path d="M12 5v14M5 12h14" />,
  trash: (
    <>
      <path d="M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M6.5 7l.8 12.2a2 2 0 0 0 2 1.8h5.4a2 2 0 0 0 2-1.8L17.5 7M10 11v6M14 11v6" />
    </>
  ),
